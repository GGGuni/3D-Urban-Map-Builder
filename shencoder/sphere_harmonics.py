...
class _sh_encoder(Function):
    ...
    # degree = 계산할 구면 조화함수의 차수
    #     print("shencoder forward")
    ...
    def backward(ctx, grad):
        ...
        if dy_dx is not None:
            ...
            torch.save(grad_inputs, 'grad_dir.pth')
            # print("grad_inputs",grad_inputs.size())
